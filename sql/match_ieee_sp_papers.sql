-- ============================================================
-- IEEE Symposium on Security and Privacy CSDL 论文表的检索 RPC
-- ============================================================

create or replace function match_ieee_sp_papers_exact(
...
create or replace function match_ieee_sp_papers_bm25(
  query_text text,
  match_count int,
  filter_published_start timestamptz default null,
  filter_published_end timestamptz default null
